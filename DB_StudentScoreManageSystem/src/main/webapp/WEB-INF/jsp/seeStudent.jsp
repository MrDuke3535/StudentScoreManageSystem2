...
<body onload="init_load()">
	...
	<div class="container-fluid">
        ...
        <div class="form-inline" style="margin-left: 5%;margin-bottom: 25px;margin-top: 10px;float: left">
            <label for="search2" class="sr-only">请输入学号或学生姓名</label>
            <input type="text" class="form-control input-lg" onkeypress="keyEntry4()" id="search2" placeholder="请输入学号或学生名">

            <button  class="btn  btn-default btn-lg" onclick="search2()" id="searchBtn2">查询</button>
        </div>
        ...
        <button type="button" class="btn btn-lg" style="margin-right: 15px;float: right;margin-bottom: 5px;" onclick="download()">
            <span class="glyphicon glyphicon-cog" aria-hidden="true"></span>
            下载班级成绩表
        </button>
